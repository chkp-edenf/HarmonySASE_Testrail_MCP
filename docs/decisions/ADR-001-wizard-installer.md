...
**Deciders**: TestRail MCP Contributors (owner), arkitect (design)
...
2. **Direct uvx** — `uvx --from git+https://github.com/<your-org>/<your-repo>.git testrail-mcp` with env vars set ahead of time.
