...
- [ ] Step 0.2: Verify `uv` version and `uvx --from git+<repo>` support (S)
  - Files: none.
  - Test first: no.
  - Verify: `uv --version`; `uvx --from git+https://github.com/<your-org>/<your-repo>.git@main testrail-mcp --help` returns 0 (Resolution #3 confirmed `v2.0.0` tag is not pushed; probe uses `@main`). Record minimum `uv` version in `install.sh` comment.
...
- [ ] Step 1.1: Add pytest to dev optional deps (S)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/pyproject.toml`
...
- [ ] Step 1.2: Create `tests/` package skeleton and shared fixtures (M)
  - Files:
    - `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/tests/__init__.py` (empty)
    - `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/tests/conftest.py`
...
- [ ] Step 1.3: Write first red test — module import + `--dry-run` smoke (S)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/tests/test_installer.py`
...
- [ ] Step 2.1: Create `src/installer.py` with argparse skeleton (M)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/src/installer.py`
...
- [ ] Step 2.2: Credential precedence resolution (M)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/src/installer.py`, `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/tests/test_installer.py`
  - Test first: yes.
...
- [ ] Step 7.1: `install.sh` POSIX bootstrapper (M)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/install.sh`
  ...
  - Contents:
    ...
    - `exec uvx --from "git+https://github.com/<your-org>/<your-repo>.git@${TESTRAIL_MCP_REF}" testrail-mcp-install "$@"` (forwards all flags).
...
- [ ] Step 7.2: `install.ps1` Windows bootstrapper (M)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/install.ps1`
  ...
  - Contents:
    ...
    - `& uvx --from "git+https://github.com/<your-org>/<your-repo>.git@$Ref" testrail-mcp-install @args` (forwards all args via PowerShell splat).
...
- [ ] Step 8.1: `.gitignore` allow-list update (S)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/.gitignore`
...
- [ ] Step 8.3: README.md Quick Install prepend (S)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/README.md`
  - Test first: no (docs).
  ...
  - Insert a new `## Quick Install (Wizard)` section immediately after the `## Highlights` section and **before** the existing `## Quick Start` section. Content:
    - macOS/Linux: `curl -LsSf https://raw.githubusercontent.com/<your-org>/<your-repo>/main/install.sh | sh`
    - Windows (PowerShell): `irm https://raw.githubusercontent.com/<your-org>/<your-repo>/main/install.ps1 | iex`
...
- [ ] Step 9.1: End-to-end smoke tests (S)
  ...
  - Commands (all must pass):
    ...
    2. `uv build` succeeds; produces `dist/_testrail_mcp-2.0.0-py3-none-any.whl`.
...
- [ ] Step 10.1: Release checklist note (S)
  - Files: `/Users/edenf/Projects/checkpoint/Eden/Tools/BMAD_<your-repo>/docs/RELEASE_CHECKLIST.md` (NEW) or append to existing if present.
  - Test first: no (docs).
  - Complexity: S (~15 LoC).
  - Depends on: 8.3.
  - Content (new file):
