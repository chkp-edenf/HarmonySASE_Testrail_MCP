...
6. **Smoke-test the one-liners** from a clean shell (new terminal, no cached `uv`):
   - `curl -LsSf https://raw.githubusercontent.com/<your-org>/<your-repo>/vX.Y.Z/install.sh | sh` on macOS/Linux.
   - `irm https://raw.githubusercontent.com/<your-org>/<your-repo>/vX.Y.Z/install.ps1 | iex` on Windows.
